...
public class CardsController {
    ...
    final Logger logger =
            LoggerFactory.getLogger(CardsController.class);
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CardsDto> fetchCard(@RequestParam  @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits") String mobileNumber, @RequestHeader("dreambank-correlation-id") String correlationHeader)
    {
        logger.debug("Feaching the card details using CorrelationId: {}", correlationHeader);
